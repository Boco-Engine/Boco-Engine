...
init_engine :: proc(using engine: ^Engine) -> (ok: bool = false) {
    ...
    // LOAD MESH
    // add_mesh(&renderer, "planet/lod1-chunk-0.bocom")
    // add_mesh(&renderer, "planet/lod1-chunk-1.bocom")
    // add_mesh(&renderer, "planet/lod0-chunk-2.bocom")
    // add_mesh(&renderer, "planet/lod0-chunk-3.bocom")
    // add_mesh(&renderer, "planet/lod1-chunk-4.bocom")
    // add_mesh(&renderer, "planet/lod1-chunk-5.bocom")
    // add_mesh(&renderer, "planet/lod1-chunk-6.bocom")
    // add_mesh(&renderer, "planet/lod1-chunk-7.bocom")
    // add_mesh(&renderer, "planet/lod1-chunk-8.bocom")
    // add_mesh(&renderer, "planet/lod1-chunk-9.bocom")
    // add_mesh(&renderer, "planet/lod1-chunk-10.bocom")
    // add_mesh(&renderer, "planet/lod1-chunk-11.bocom")
    // add_mesh(&renderer, "planet/lod1-chunk-12.bocom")
    // add_mesh(&renderer, "planet/lod1-chunk-13.bocom")
    // add_mesh(&renderer, "planet/lod1-chunk-14.bocom")
    // add_mesh(&renderer, "planet/lod1-chunk-15.bocom")
    // add_mesh(&renderer, "planet/lod1-chunk-16.bocom")
    // add_mesh(&renderer, "planet/lod1-chunk-17.bocom")
    // add_mesh(&renderer, "planet/lod1-chunk-18.bocom")
    // add_mesh(&renderer, "planet/lod1-chunk-19.bocom")
